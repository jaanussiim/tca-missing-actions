...
internal class ViewController: UIViewController {
    private lazy var client = TimeEntriesClient(
        onLoadEntries: {
            _ in
    ...
    private lazy var appView = ApplicationView(store: store)
    private lazy var hosting = UIHostingController(rootView: appView)
